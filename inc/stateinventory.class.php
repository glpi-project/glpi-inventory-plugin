...
class PluginGlpiinventoryStateInventory extends CommonDBTM
{
    ...
    public function __construct()
    {
        ...
        $CFG_GLPI['glpitablesitemtype']['PluginGlpiinventoryStateInventory'] = 'glpi_plugin_glpiinventory_taskjobstates';
    }
        ...
        foreach ($iterator as $data) {
            ...
            if ($start_date == '') {
                ...
                if (strtotime($end_date) - strtotime($start_date) > 0) {
                    $nb_per_second = round(($nb_query - $nb_errors) / (strtotime($end_date) - strtotime($start_date)), 2);
                }
