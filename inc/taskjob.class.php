    ...
    */
    public function dropdownType($myname, $method, $value = 0, $taskjobs_id = 0, $entity_restrict = '')
    {
        ...
        Ajax::updateItemOnEvent(
            ...
            plugin_glpiinventory_geturl() . "/ajax/dropdowntypelist.php",
            $params
        );
    ...
    */
    public function dropdownvalue(
        ...
        Ajax::updateItemOnEvent(
            ...
            "Additem_$rand",
            plugin_glpiinventory_geturl() . "/ajax/taskjobaddtype.php",
            $params,
            ["click"],
            "-1",
            "-1",
    ...
    */
    public function dropdownActionType($myname, $method, $value = 0, $entity_restrict = '')
    {
        ...
        Ajax::updateItemOnSelectEvent(
            ...
            "show_ActionList",
            plugin_glpiinventory_geturl() . "/ajax/dropdownactionlist.php",
            $params
        );
    ...
    */
    public function dropdownAction(
        ...
        return Ajax::updateItemOnEvent(
            ...
            plugin_glpiinventory_geturl() . "/ajax/dropdownactionselection.php",
            $params,
            ["click"]
        );
    }
      ...
      Ext.get('" . $type . $taskjobs_id . "').setDisplayed('none');
       ...
       // reload item list
        ...
        Ajax::updateItemJsCode(
            ...
            plugin_glpiinventory_geturl() . "/ajax/dropdownlist.php",
            $params
        );
        echo "</script>";
    }
