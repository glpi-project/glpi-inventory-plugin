...
class PluginGlpiinventoryInventoryComputerBlacklist extends CommonDBTM
{
    ...
    */
    public function showForm($items_id, array $options = [])
    {
        ...
        echo "<td>";
        Dropdown::show(
            'PluginGlpiinventoryInventoryComputerCriteria',
            ...
            switch ($data['comment']) {
                case 'ssn':
                    ...
                    foreach ($a_blacklist as $blacklist_id => $blacklist_data) {
                        if (
                            (isset($a_computerinventory['Computer']['serial']))
                ...
                case 'uuid':
                    ...
                    foreach ($a_blacklist as $blacklist_id => $blacklist_data) {
                        if (
                            (isset($a_computerinventory['Computer']['uuid']))
                ...
                case 'winProdKey':
                    ...
                    foreach ($a_blacklist as $blacklist_id => $blacklist_data) {
                        if (
                            (isset($a_computerinventory['inventorycomputer']['items_operatingsystems_id']['license_number']))
                ...
                case 'smodel':
                    ...
                    foreach ($a_blacklist as $blacklist_id => $blacklist_data) {
                        if (
                            (isset($a_computerinventory['Computer']['computermodels_id']))
                ...
                case 'manufacturer':
                    ...
                    foreach ($a_blacklist as $blacklist_id => $blacklist_data) {
                        if (
                            (isset($a_computerinventory['Computer']['manufacturers_id']))
