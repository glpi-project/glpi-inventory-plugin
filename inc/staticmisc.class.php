...
class PluginGlpiinventoryStaticmisc
{
    ...
    {
        $a_itemtype['PluginGlpiinventoryCredentialIp'] = PluginGlpiinventoryCredentialIp::getTypeName();
    ...
    public static function task_networkdiscovery_agents()
    {
        ...
        foreach ($array1 as $id => $data) {
            $array['PluginGlpiinventoryAgent-' . $id] = __('Auto management dynamic of agents', 'glpiinventory') . ' - ' . $data['name'];
        }
